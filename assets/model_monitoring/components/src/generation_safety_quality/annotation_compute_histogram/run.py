        ...
        **kwargs,
        ...
        try:
            ...
            if os.environ.get("AZUREML_RUN_ID", None) is not None:
                ...
                if hasattr(connection.metadata, "DeploymentApiVersion"):
                    api_version = connection.metadata["DeploymentApiVersion"]
                # api version
                ...
                self.api_type = None
                if hasattr(connection.metadata, "ApiType"):
                    self.api_type = connection.metadata["ApiType"]
            else:
